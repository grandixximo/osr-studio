...
namespace OsrStudio.Windows
{
    public class HardwareInfoService : IHardwareInfoService
    {
        ...
        public HardwareInfoService()
        {
            try
            {
                ...
                if (adapter != null)
                {
                    ...
                    HasAmdEncoder = GpuVendor == OsrStudio.GpuVendor.AMD;
                    HasNvidiaEncoder = GpuVendor == OsrStudio.GpuVendor.NVIDIA;
                    HasIntelQuickSync = GpuVendor == OsrStudio.GpuVendor.Intel;
                }
                else
                {
                    GpuName = "No GPU detected";
                    GpuVendor = OsrStudio.GpuVendor.Unknown;
                    HasAmdEncoder = false;
        ...
        private static GpuVendor DetectVendor(Adapter1 adapter)
        {
            ...
            {
                0x1002 => OsrStudio.GpuVendor.AMD,
                0x10DE => OsrStudio.GpuVendor.NVIDIA,
                0x8086 => OsrStudio.GpuVendor.Intel,
